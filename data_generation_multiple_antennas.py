...
for snr_dB in tqdm(snr_dB_range):
    ...
    while num_sample <= num_sample_per_snr:
        ...
        # Extract preamble
        received_test_signal = received_test_signal[:, start_mapping_symbol:(end_mapping_symbol + 1)]
        ...
        received_test_signal = received_test_signal[prach_ofdm_information.cyclicPrefixLen:]
