...
num_frame = 1
num_slot = 1
signal_len = num_frame * 1228800 + 1
test_data = []

for sample_index in range(num_sample):
    random_generated_sample = np.random.rand(num_rx_antennas, signal_len)
    test_data.append(random_generated_sample)

starting_symbol = []
starting_symbol.append(np.zeros((num_rx_antennas, num_slot)) + 921600)
ending_symbol = []
ending_symbol.append(np.zeros((num_rx_antennas, num_slot)) + 972687)
