...
train_dl, val_dl, test_dl = create_loaders_tensor_data(datasets, bs=bs)
...
model = torch.hub.load('pytorch/vision:v0.10.0', model_name, pretrained=True).to(device)
